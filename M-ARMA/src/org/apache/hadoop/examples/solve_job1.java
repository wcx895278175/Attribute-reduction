...
//	private  Ant[] ants; //蚂蚁
	...
	public static void start(int AttributeNum,float alpha, float beta,float relyDtoC,int ant_num,float numberOfElements,float MAX_GEN) throws Exception {
		...
		//路径
		String[] job1_path = new String[]  {"/2k_20/antstart_2k_20.txt", "/2k_20/reduction1" };
		String[] job2_path = new String[]  {"/2k_20/reduction2/part-r-00000","/2k_20/reduction3"} ;
		String[] job4_path = new String[]  {"/2k_20/reduction3/part-r-00000","/2k_20/reduction4"} ;
		String[] job5_path = new String[]  {"/2k_20/reduction4/part-r-00000","/2k_20/reduction5"} ;
		String[] job6_path = new String[]  {"/2k_20/reduction5/part-r-00000","/2k_20/reduction6"} ;
		String[] job7_path = new String[]  {"/2k_20/reduction6/part-r-00000","/2k_20/reduction7"} ;
		String[] job8_path = new String[]  {"/2k_20/reduction7/part-r-00000","/2k_20/reduction8"} ;
		String[] job9_path = new String[]  {"/2k_20/reduction8/part-r-00000","/2k_20/reduction9"} ;
		String[] job10_path = new String[] {"/2k_20/reduction9/part-r-00000","/2k_20/reduction10"} ;
		String file_phe = "/2k_20/2k_20_phe.txt";	
...
//				}
			...
			//更新信息素,信息素挥发  
			FSDataOutputStream dos = fs.create(new Path("/2k_20/2k_20_phe.txt"));
			for(int i = 1; i <= AttributeNum ; i++) {
	    		 for(int j = 1 ; j <= AttributeNum ; j++)  {
